...
\chapter{Análisis}
	...
	Partiendo de una matriz de puntos x-y (voltaje-tiempo), nuestro objetivo es producir una recta frecuencia-tiempo.
	
	
	
	
	
	A la vista de este problema, y dado que 
