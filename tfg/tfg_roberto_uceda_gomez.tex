...
\chapter{Estado del arte}
	...
	Un transistor MOSFET es un tipo de transistor bipolar que se usa para amplificar y conmutar señales eléctricas dentro de un circuito. Se compone de cuatro entradas: fuente, puerta, drenador, y sustrato, que normalmente está conectado a la fuente. Cuando se aplica un voltaje en la puerta, se crea un canal en el medio semiconductor que permite el paso de corriente entre la fuente y el drenador. Este voltaje es positivo en caso de los transistores de canal n, y negativo en los de canal p. Usándolos como interruptores se construyen los bloques lógicos de los microprocesadores.
	
	\section{Tecnología CMOS}
	
	La tecnología de fabricación CMOS\footnote{Complementary MOS} utiliza una combinación de transistores MOSFET de canal n y canal p para implementar las funciones de un microprocesador.
